...
def main():
    ...
    model_file_name = 'vgg_face_weights.h5'
    ...
    # -------prepare dataset-----------
    pd = PrepareDataset()
    x_train, y_train, x_test, y_test, person_rep = pd.prepare_data('C:\lfw/',vgg_face)
    #print(model.summary())
    ...
    faceTest.test_facerecog_in_dir(dnnfacedetector,vgg_face,classifier_model,person_rep,'C:\lfw\images')
    print('done..')
